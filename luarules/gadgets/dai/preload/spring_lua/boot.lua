...
function shard_include( file , subf)
	...
	local gameFile = "luarules/gadgets/dai/" ..  subdir .. "/" .. file .. ".lua"
	local baseFile = "luarules/gadgets/dai/" .. file .. ".lua"
	local preloadFile = "luarules/gadgets/dai/preload/" .. file .. ".lua"
